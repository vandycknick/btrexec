...
namespace Nvd.SubProcess.Native
{
    ...
    internal struct sa_family_t : IEquatable<sa_family_t>
    {
    ...
    internal struct uid_t : IEquatable<uid_t>
    {
    ...
    internal struct socklen_t : IEquatable<socklen_t>
    {
        private uint __value;
        internal uint Value => __value;
    ...
    internal struct off_t : IEquatable<off_t>
    {
    ...
    internal struct time_t : IEquatable<time_t>
    {
    ...
    internal struct clock_t : IEquatable<clock_t>
    {
    ...
    internal unsafe struct pthread_t : IEquatable<pthread_t>
    {
    ...
    internal partial struct nlink_t
    {
        private ulong __value;
        internal ulong Value => __value;
    ...
    internal partial struct blksize_t
    {
        private long __value;
        internal long Value => __value;
